// in src/vendors/SubWasphaExpressButton.js
...
class SubWasphaExpressButton extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    return (
      <>
        <Button
          label="ra.strings.subscribe_waspha_express"
        ...
        <Confirm
          ...
          title="ra.strings.susbcribe_vendor_to_waspha_express"
...
SubWasphaExpressButton.propTypes = {
  push: PropTypes.func,
