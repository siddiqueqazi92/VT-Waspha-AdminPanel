// in src/vendors/DisAprroveButton.js
...
class DisAprroveButton extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleClick = () => {
    ...
    const updatedRecord = { store_id: record.id, is_approved: false };
    ...
    fetch(url, {
      ...
      .then(() => {
        ...
        showNotification("Vendor disapproved");
        push("/vendors");
        refresh();
      })
      ...
      .catch((e) => {
        console.error(e);
        showNotification("Error: vendor not disapproved", "warning");
      });
  };
    ...
    return (
      <>
        ...
        <Confirm
          ...
          title="ra.strings.disapprove_vendor"
